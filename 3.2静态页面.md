        ...
        <div class="card-body">
            <p class="card-text">
                <span class="h4-responsive">
                    ...
                    <br>
                    <br> 我们创建对应路径的对应文件
                    <span class="blue-text">application/index/view/index/hello.html (2018-6-14 更新)</span> 并写入 hello view
                    <br>
        ...
        <div class="card-body">
            <p class="card-text">
                <span class="h4-responsive">
                    ...
                    <div class="card green lighten-1 z-depth-2">
                        <div class="card-body">
                            <p class="white-text mb-0">
                                ...
                                <span>
                                    Route::get('hello', function() {
                                    <br> &nbsp;&nbsp;&nbsp;&nbsp;return view('index@index/hello'); (2018-6-14 更新)
                                    <br> });
                                </span>
                            </p>
                        </div>
                    ...
                    <span class="blue-text">view/index/hello.html</span> 模板文件输出。
                    <br>
                    <br> 进入到对应的模板文件，将
        ...
        <div class="card-body">
            <p class="card-text">
                <span class="h4-responsive">
                    ...
                    <br><br>
                    现在请创建一个公告模板的文件夹：<span class="blue-text">application/welcome/view/_layout</span>
                    <br><br>
                    并在该目录下创建一个 <span class="blue-text">default.html</span> 的文件并写入
                    <br><br>
                    <div class="card green lighten-1 z-depth-2">
                        <div class="card-body">
                            <p class="white-text mb-0">
...
&lt;/html&gt;
                    ...
                    <br><br>
                    然后点开 <span class="blue-text">home.html</span>，将内容修改为：
                    <br><br>
                    <div class="card green lighten-1 z-depth-2">
                        <div class="card-body">
                            <p class="white-text mb-0">
